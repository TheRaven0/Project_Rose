                        ...
                        new Response.Listener<JSONArray>()
                        {
                            ...
                            public void onResponse(JSONArray response)
                            {
                                try {
                                    ...
                                    clave1=(response.getJSONObject(1).getString("Clave1"));
                                    clave2=(response.getJSONObject(1).getString("Clave2"));
                                    clave3=(response.getJSONObject(1).getString("Clave3"));
                                    clave4=(response.getJSONObject(1).getString("Clave4"));
                                    clave5=(response.getJSONObject(1).getString("Clave5"));
